...
// string mainAccountId;                // 64‑char hex
// {
//     userAccountIdentifier = AccountHelper.FromPrincipal(iiClient.DelegateAgent.Identity.GetPrincipal());
//     mainAccountId = BitConverter.ToString(userAccountIdentifier.ToArray()).Replace("-", "").ToLowerInvariant();    // top‑level
// }

// static List<byte> SubaccountFromAccountIdHex(string hex)
// {
//     // 1. hex -> bytes
//     byte[] idBytes = Enumerable.Range(0, hex.Length / 2)
//         .Select(i => Convert.ToByte(hex.Substring(i * 2, 2), 16))
//         .ToArray();

//     /*  Ledger account‑id layout (big‑endian):
//         [ 0‒3 ]  CRC32
//         [ 4‒31 ] SHA‑224(principal + subAccount)  (28 bytes)
//         [32‒63 ] subAccount (32 bytes)           <-- we need these
//     */
//     return idBytes.Skip(4 + 28).Take(32).ToList();
// }
