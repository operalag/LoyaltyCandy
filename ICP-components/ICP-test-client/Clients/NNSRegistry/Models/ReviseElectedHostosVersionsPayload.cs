...
{
	public class ReviseElectedHostosVersionsPayload
	{
		...
		public ReviseElectedHostosVersionsPayload(List<string> releasePackageUrls, OptionalValue<string> hostosVersionToElect, List<string> hostosVersionsToUnelect, OptionalValue<string> releasePackageSha256Hex)
		{
		...
		public ReviseElectedHostosVersionsPayload()
		{
		}
	}
}