...
namespace LoyaltyCandy.NNSGovernance.Models
{
	public class NetworkEconomics
	{
		...
		[CandidName("neurons_fund_economics")]
		public OptionalValue<NeuronsFundEconomics> NeuronsFundEconomics { get; set; }

		[CandidName("voting_power_economics")]
		public OptionalValue<VotingPowerEconomics> VotingPowerEconomics { get; set; }

		public NetworkEconomics(ulong neuronMinimumStakeE8s, uint maxProposalsToKeepPerTopic, ulong neuronManagementFeePerProposalE8s, ulong rejectCostE8s, ulong transactionFeeE8s, ulong neuronSpawnDissolveDelaySeconds, ulong minimumIcpXdrRate, ulong maximumNodeProviderRewardsE8s, OptionalValue<NeuronsFundEconomics> neuronsFundEconomics, OptionalValue<VotingPowerEconomics> votingPowerEconomics)
		{
			...
			this.NeuronsFundEconomics = neuronsFundEconomics;
			this.VotingPowerEconomics = votingPowerEconomics;
		}
