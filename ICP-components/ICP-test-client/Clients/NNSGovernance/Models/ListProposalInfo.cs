...
namespace LoyaltyCandy.NNSGovernance.Models
{
	public class ListProposalInfo
	{
		...
		public OptionalValue<ProposalId> BeforeProposal { get; set; }
		...
		public ListProposalInfo(List<int> includeRewardStatus, OptionalValue<bool> omitLargeFields, OptionalValue<ProposalId> beforeProposal, uint limit, List<int> excludeTopic, OptionalValue<bool> includeAllManageNeuronProposals, List<int> includeStatus)
		{
