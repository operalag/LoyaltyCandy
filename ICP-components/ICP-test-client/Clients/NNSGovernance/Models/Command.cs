...
namespace LoyaltyCandy.NNSGovernance.Models
{
	...
	public class Command
	{
		...
		public static Command RefreshVotingPower(RefreshVotingPower info)
		{
			return new Command(CommandTag.RefreshVotingPower, info);
		}

		public static Command DisburseMaturity(DisburseMaturity info)
		{
			return new Command(CommandTag.DisburseMaturity, info);
		}
		...
		{
			this.ValidateTag(CommandTag.RefreshVotingPower);
			return (RefreshVotingPower)this.Value!;
		}

		public DisburseMaturity AsDisburseMaturity()
		{
			this.ValidateTag(CommandTag.DisburseMaturity);
