...
namespace LoyaltyCandy.NNSGovernance.Models
{
	...
	{
		[CandidName("id")]
		public OptionalValue<ProposalId> Id { get; set; }
		...
		[CandidName("neurons_fund_data")]
		public OptionalValue<NeuronsFundData> NeuronsFundData { get; set; }
		...
		public ProposalData(OptionalValue<ProposalId> id, OptionalValue<GovernanceError> failureReason, Dictionary<ulong, Ballot> ballots, ulong proposalTimestampSeconds, ulong rewardEventRound, ulong failedTimestampSeconds, OptionalValue<NeuronsFundData> neuronsFundData, ulong rejectCostE8s, OptionalValue<DerivedProposalInformation> derivedProposalInformation, OptionalValue<Tally> latestTally, OptionalValue<int> snsTokenSwapLifecycle, ulong decidedTimestampSeconds, OptionalValue<Proposal> proposal, OptionalValue<NeuronId> proposer, OptionalValue<WaitForQuietState> waitForQuietState, ulong executedTimestampSeconds, OptionalValue<ulong> originalTotalCommunityFundMaturityE8sEquivalent, OptionalValue<ulong> totalPotentialVotingPower)
		{
			this.Id = id;
			...
			this.NeuronsFundData = neuronsFundData;
