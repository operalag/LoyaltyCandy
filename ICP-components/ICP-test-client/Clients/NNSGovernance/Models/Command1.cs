...
namespace LoyaltyCandy.NNSGovernance.Models
{
	...
	public class Command1
	{
		...
		public static Command1 RefreshVotingPower(RefreshVotingPowerResponse info)
		{
			return new Command1(Command1Tag.RefreshVotingPower, info);
		}

		public static Command1 DisburseMaturity(DisburseMaturityResponse info)
		{
			return new Command1(Command1Tag.DisburseMaturity, info);
		}
		...
		public RefreshVotingPowerResponse AsRefreshVotingPower()
		{
			this.ValidateTag(Command1Tag.RefreshVotingPower);
			return (RefreshVotingPowerResponse)this.Value!;
		}

		public DisburseMaturityResponse AsDisburseMaturity()
		{
			this.ValidateTag(Command1Tag.DisburseMaturity);
			return (DisburseMaturityResponse)this.Value!;
		}
