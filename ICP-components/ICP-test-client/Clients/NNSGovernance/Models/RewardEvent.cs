...
namespace LoyaltyCandy.NNSGovernance.Models
{
	public class RewardEvent
	{
		...
		public List<ProposalId> SettledProposals { get; set; }

		public RewardEvent(OptionalValue<ulong> roundsSinceLastDistribution, ulong dayAfterGenesis, ulong actualTimestampSeconds, ulong totalAvailableE8sEquivalent, OptionalValue<ulong> latestRoundAvailableE8sEquivalent, ulong distributedE8sEquivalent, List<ProposalId> settledProposals)
		{
