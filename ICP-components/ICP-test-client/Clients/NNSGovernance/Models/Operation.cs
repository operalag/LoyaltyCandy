...
namespace LoyaltyCandy.NNSGovernance.Models
{
	...
	public class Operation
	{
		...
		public static Operation SetVisibility(SetVisibility info)
		{
			return new Operation(OperationTag.SetVisibility, info);
		}
		...
		public SetVisibility AsSetVisibility()
		{
			this.ValidateTag(OperationTag.SetVisibility);
			return (SetVisibility)this.Value!;
		}
