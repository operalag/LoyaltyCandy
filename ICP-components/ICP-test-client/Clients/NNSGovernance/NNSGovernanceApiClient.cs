...
using LoyaltyCandy.NNSGovernance;
using System.Collections.Generic;
using EdjCase.ICP.Agent.Responses;

namespace LoyaltyCandy.NNSGovernance
{
	public class NNSGovernanceApiClient
	{
		public IAgent Agent { get; }
		public Principal CanisterId { get; }
		public CandidConverter? Converter { get; }

		public NNSGovernanceApiClient(IAgent agent, Principal canisterId, CandidConverter? converter = default)
		{
			this.Agent = agent;
		...
		public async Task<OptionalValue<Models.MonthlyNodeProviderRewards>> GetMostRecentMonthlyNodeProviderRewards()
		{
			CandidArg arg = CandidArg.FromCandid();
			QueryResponse response = await this.Agent.QueryAsync(this.CanisterId, "get_most_recent_monthly_node_provider_rewards", arg);
			CandidArg reply = response.ThrowOrGetReply();
			return reply.ToObjects<OptionalValue<Models.MonthlyNodeProviderRewards>>(this.Converter);
		}
		...
		public async Task<Models.GetNeuronsFundAuditInfoResponse> GetNeuronsFundAuditInfo(Models.GetNeuronsFundAuditInfoRequest arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
			QueryResponse response = await this.Agent.QueryAsync(this.CanisterId, "get_neurons_fund_audit_info", arg);
			CandidArg reply = response.ThrowOrGetReply();
			return reply.ToObjects<Models.GetNeuronsFundAuditInfoResponse>(this.Converter);
		}

		public async Task<Models.Result7> GetNodeProviderByCaller(NullValue arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
		...
		public async Task<Models.RestoreAgingSummary> GetRestoreAgingSummary()
		{
			CandidArg arg = CandidArg.FromCandid();
			QueryResponse response = await this.Agent.QueryAsync(this.CanisterId, "get_restore_aging_summary", arg);
			CandidArg reply = response.ThrowOrGetReply();
			return reply.ToObjects<Models.RestoreAgingSummary>(this.Converter);
		}
		...
		public async Task<Models.ListNodeProviderRewardsResponse> ListNodeProviderRewards(Models.ListNodeProviderRewardsRequest arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
			QueryResponse response = await this.Agent.QueryAsync(this.CanisterId, "list_node_provider_rewards", arg);
			CandidArg reply = response.ThrowOrGetReply();
			return reply.ToObjects<Models.ListNodeProviderRewardsResponse>(this.Converter);
		}
		...
		public async Task<Models.ManageNeuronResponse> ManageNeuron(Models.ManageNeuronRequest arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
		...
		public async Task<Models.SettleNeuronsFundParticipationResponse> SettleNeuronsFundParticipation(Models.SettleNeuronsFundParticipationRequest arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
			CandidArg reply = await this.Agent.CallAsync(this.CanisterId, "settle_neurons_fund_participation", arg);
			return reply.ToObjects<Models.SettleNeuronsFundParticipationResponse>(this.Converter);
		}

		public async Task<Models.ManageNeuronResponse> SimulateManageNeuron(Models.ManageNeuronRequest arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
		...
		public async Task<OptionalValue<Models.GovernanceError>> UpdateNeuron(Models.Neuron arg0)
		{
			CandidArg arg = CandidArg.FromCandid(CandidTypedValue.FromObject(arg0, this.Converter));
			CandidArg reply = await this.Agent.CallAsync(this.CanisterId, "update_neuron", arg);
			return reply.ToObjects<OptionalValue<Models.GovernanceError>>(this.Converter);
		}
